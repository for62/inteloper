        ...
        <fieldset class="fieldset_common_style">
            <table class="table_common_style">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" name="omvalue" value=""
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" name="alkelinen" value=""
                               data-options="min:0,max:999999999.99,precision:2,groupSeparator:','"
                               style="width:170px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" name="olsenp" value=""
                               data-options="min:0,max:999999999.99,precision:2,groupSeparator:','"
                               style="width:170px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" name="olsenk" value=""
                               data-options="min:0,max:999999999.99,precision:2,groupSeparator:','"
                               style="width:170px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" name="ph" value=""
                               data-options="min:0,max:999999999.99,precision:2,groupSeparator:','"
                               style="width:170px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
