...
<div region="center" border="false" style="padding:5px;">
    <fieldset id="queryBlock" class="fieldset_common_style">
        <form id="listform" name="listform" method="post"
              action="${pageContext.request.contextPath}/yieldPredict/list?flag=2">
    ...
    <fieldset id="pingguBlock" class="fieldset_common_style">
        ...
        <table class="table_common_style">
            ...
            <tr>
                ...
                <td class="table_common_td_txt_style">
                    <input id="buyValue" value="0.0" class="easyui-textbox" style="width:120px;height:25px" readonly>
                </td>
            </tr>
            <tr>
                ...
                <td class="table_common_td_txt_style">
                    <input id="restPredictYield" value="0.0" class="easyui-textbox" style="width:120px;height:25px"
                           readonly></td>
            </tr>
        </table>
    </fieldset>
