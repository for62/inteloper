            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        ...
                        <select id="productCode" name="productCode" class="easyui-combobox" editable="false"
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" id="num" name="num" style="width:200px;height:25px"
                               data-options="min:0,max:99999999999"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
                <tr height="50">
                    <td colspan="2" align="center">
                        ...
                        <a href="#" style="margin-left:50px;" class="easyui-linkbutton" style="margin-left:15px;"
                           onclick="closeDialog()" data-options="iconCls:'icon-cancel'">关闭</a>
                    </td>
                </tr>
            </table>
        </fieldset>
