...
<div region="center" border="false" style="padding:5px;">
    <fieldset id="queryBlock" class="fieldset_common_style">
        <form id="seclistform" name="seclistform" method="post"
              action="${pageContext.request.contextPath}/securityCode/seclist?flag=2">
            <table class="table_common_style">
                ...
                <tr>
                    ...
                    <td colspan="2" class="table_common_td_txt_query_style">
                        <input name="produceDate" id="produceDate" class="easyui-datebox" value=""
                               data-options="required:false,showSeconds:false" style="width:120px" editable="false"/>
                    </td>
        ...
        <table class="table_common_style">
            <tr>
                ...
                <td class="table_common_td_txt_style">
                    <input id="evalYield" value="0.0" class="easyui-textbox" style="width:100px;height:25px" readonly>
                </td>
                <td class="table_common_td_label_style">已预报产量（斤）：</td>
                <td class="table_common_td_txt_style">
                    <input id="predictedYield" value="0.0" class="easyui-textbox" style="width:100px;height:25px"
                           readonly></td>
                <td class="table_common_td_label_style">已激活产量（斤）：</td>
                <td class="table_common_td_txt_style">
                    <input id=sameleYield value="0.0" class="easyui-textbox" style="width:100px;height:25px" readonly>
                </td>
            </tr>
            <tr>
                <td class="table_common_td_label_style">未申请产量（斤）：</td>
                <td class="table_common_td_txt_style">
                    <input id="noApplyCodeCount" value="0.0" class="easyui-textbox" style="width:100px;height:25px"
                           readonly></td>
                <td class="table_common_td_label_style">已申请数量：</td>
                <td class="table_common_td_txt_style">
                    <input id="applyCodeCount" value="0" class="easyui-textbox" style="width:100px;height:25px"
                           readonly></td>
                <td class="table_common_td_label_style">已激活数量：</td>
                <td class="table_common_td_txt_style">
                    <input id="activateCodeCount" value="0" class="easyui-textbox" style="width:100px;height:25px"
                           readonly></td>
            </tr>
        </table>
    </fieldset>
    <table id="data" class="easyui-datagrid" striped="true" checkbox="true" singleSelect="true" pageSize="15"
           pageNumber="1">
        <thead>
        <tr>
