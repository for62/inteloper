        ...
        <fieldset class="fieldset_common_style">
            <table style="width: 100%" align="left">
                ...
                <tr>
                    ...
                    <td class="table_common_td_label_style">证件类型：</td>
                    <td class="table_common_td_txt_style editableFalse">
                        <input class="easyui-textbox" type="text" id="contractorID" name="contractorID" value=""
                               style="width:189px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
        ...
        <fieldset class="fieldset_common_style">
            <table style="width: 100%" align="left">
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" id="contractorName" name="contractorName" value=""
                               style="width:188px;" maxlength="10" readOnly></input>
                    </td>
                    <td class="table_common_td_label_style">联系方式：</td>
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" id="contractorTel" name="contractorTel" value=""
                               style="width:189px;" readOnly></input>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" class="table_common_td_txt_style">
                        ...
                        <select class="easyui-combobox" id="townCodeView" name="townCodeView"
                                data-options="editable:false" style="width:187px;" disabled>
                            <option value="" selected></option>
                        </select>
                        <input type="hidden" id="townCode" name="townCode" value="">

                        <select class="easyui-combobox" id="countryCodeView" name="countryCodeView"
                                data-options='editable:false' style="width:187px;" disabled>
                            <option value="" selected></option>
                        </select>
                        <input type="hidden" id="countryCode" name="countryCode" value="">

                        <input type="text" class="easyui-textbox" id="address" name="address" value=""
                               readonly="readonly" style="width:440px;">
                    </td>
            ...
            <table style="width: 100%" align="left">
                ...
                <tr>
                    ...
                    <td colspan="5" class="table_common_td_txt_style">
                        <textarea class="easyui-textbox" rows="3" id="changeReason" name="changeReason" cols="60"
                                  style="font-size:12px;height:100px" data-options="multiline:true"></textarea>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        ...
                        <input class="easyui-textbox" type="text" id="applicant" name="applicant" value="管理员"
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" id="applicantTel" name="applicantTel" value=""
                               style="width:189px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                    <td colspan="2">
                ...
                <tr>
                    <td align="left">
                        <a href="#" class="easyui-linkbutton"
                           onclick="javascript:showUploadDialog('20', '', '举证资料', 'imgPriviewOuter', 'imgPriviewInner');">
                            <span class="l-btn-left"><span
                                    class="l-btn-text icon-docupload l-btn-icon-left">上传申请凭证</span></span>
                        </a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table id="imgList" height="152px" class="easyui-datagrid" striped="true" singleSelect="true">
                            <thead>
                            <tr>
                                <th field="originalName" width="50%" align="center">申请凭证
                                </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if ($('#contractorID').val() != "") {
            var params = {
                'companyCode': $("#companyCode1").combobox('getValue'),
                'yearCode': $('#year').combobox('getValue'),
                'idType': $("#idType").combobox('getValue'),
    ...
    function initInterfaceInfo(data) {
        ...
        var params = {
            ...
            'townCode': contratorInfo.townCode,
            'countryCode': contratorInfo.countryCode
        };
