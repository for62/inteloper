    ...
    <form>
        <fieldset class="fieldset_common_style">
            ...
            <table class="table_common_style">
                ...
                <tr height="30">
                    <td colspan="2" align="center">
                        <a href="#" id="uploadDiv1" class="easyui-linkbutton" style="height:30px; width:100px;"
                           onclick="importTempDown()">导入模板下载</a>
                        <a href="#" id="uploadDiv" class="easyui-linkbutton"
                           style="margin-left:40px;height:30px; width:80px;" onclick="upload()">上传</a>
                        <a href="#" id="uploadDiv" class="easyui-linkbutton"
                           style="margin-left:40px;height:30px; width:80px;" onclick="closeUploadDialog()">关闭</a>
                    </td>
                </tr>
            </table>
        </fieldset>
        <fieldset class="fieldset_common_style" id="teID">
            <table width="100%">
                <tr>
                    <td width="90%">
                        <table id="errorData" height="100px;" class="easyui-datagrid" striped="true"
