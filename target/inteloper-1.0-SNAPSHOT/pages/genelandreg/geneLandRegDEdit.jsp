...
<div region="center" border="false" style="padding:5px;">
    <table id="data">
        <tr>
            <th>
                <a href="#" class="easyui-linkbutton" style="margin-left:1px; width:80px;"
                   onclick="return sureLandRegD();">
                ...
                <a href="#" class="easyui-linkbutton" style="margin-left:1px; width:80px;"
                   onclick="return closeEditDialog();">
						<span class="l-btn-left">
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input name="contractorID" id="contractorID" value="" class="easyui-textbox"
                               style="width:150px;">
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                    <td align="center">
                        <a href="#" class="easyui-linkbutton" onclick="return expandInfo();">
                            <span class="l-btn-left"><span
                                    class="l-btn-text icon-search l-btn-icon-left">确权查询</span></span>
                        </a>
                    </td>
                </tr>
            </table>
    ...
    <fieldset class="fieldset_common_style">
        <table class="table_common_style">
            <tr>
                ...
                <td class="table_common_td_txt_style">
                    <input class="easyui-textbox" name="tmp_contractorName" id="tmp_contractorName" readonly="readonly"
                           value="" style="width:150px;">
                </td>
                <td class="table_common_td_label_style">联系方式：</td>
                <td class="table_common_td_txt_style">
                    <input class="easyui-textbox" name="tmp_contractorTel" id="tmp_contractorTel" value=""
                           style="width:150px;">
                    <span class="span_common_mustinput_style">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="5" class="table_common_td_txt_style">
                    ...
                    <input type="text" class="easyui-textbox" id="tmp_groupName" name="tmp_groupName" value=""
    ...
    <fieldset class="fieldset_common_style">
        <table class="table_common_style">
            <tr>
                ...
                <td class="table_common_td_txt_style">
                    <input name="zmj" id="zmj" readonly="readonly" value="" class="easyui-textbox"
                           style="background-color:#B0B0B0;width:150px;">
                </td>
                <td class="table_common_td_label_style">已备案面积（亩）：</td>
                <td class="table_common_td_txt_style">
                    <input name="ybamj" id="ybamj" readonly="readonly" value="" class="easyui-textbox"
                           style="background-color:#B0B0B0;width:150px;">
                </td>
            </tr>
            <tr>
                ...
                <td class="table_common_td_txt_style">
                    <input name="kbamj" id="kbamj" readonly="readonly" value="" class="easyui-textbox"
                           style="background-color:#B0B0B0;width:150px;">
                </td>
                <td class="table_common_td_label_style"><strong>本次备案面积（亩）：</strong></td>
                <td class="table_common_td_txt_style">
                    <input name="tmp_archiveAcreage" id="tmp_archiveAcreage" value="" class="easyui-numberbox"
                           precision="2" min="0.00" max="9999999.99" value="" style="width:150px;">
                    <span class="span_common_mustinput_style">*</span>
                </td>
            </tr>
            <tr>
                ...
                <td class="table_common_td_txt_style">
                    <input name="tmp_operatorName" id="tmp_operatorName" value="" type="text" class="easyui-textbox"
                           style="width:150px;">
                    <span class="span_common_mustinput_style">*</span>
                </td>
...
<script type="text/javascript">
    ...
    function sureLandRegD(id) {
        ...
        var optFlag = "${flag}";
        if (optFlag == "edit") {
            $('#geneLandData').datagrid('updateRow', {
                index: parseInt('${rowIndex}'), row: {
    ...
    function initInterfaceInfo(data) {
        ...
        var params = {
            'cityCode': $('#tmp_cityCode').combobox('getValue'),
