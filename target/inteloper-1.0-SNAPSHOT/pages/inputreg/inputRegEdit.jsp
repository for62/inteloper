    ...
    <form id="addFrom" class="easyui-form" method="post" data-options="novalidate:true">
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td colspan="3" class="table_common_td_txt_style">
                        <input class="easyui-textbox" readonly type="text" name="applyBatchNo" value="TR20170521000007"
                               style="width:187px;"></input>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="inputGoodsName" value=""
                               style="width:187px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" precision="2" min="0.00" max="9999999.99" type="text"
                               name="purchaseQuantity" value="" style="width:100px;"></input>


                        <select id="inputGoodsUnit" name="inputGoodsUnit" class="easyui-combobox"
                                style="width:85px;height:22px" data-options="editable:true">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="inputGoodsSupplier" value=""
                               style="width:187px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="purchasePerson" value=""
                               style="width:187px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
        ...
        <fieldset class="fieldset_common_style">
            ...
            <table class="table_common_style">
                <tr>
                    <td>
                        <a href="#" class="easyui-linkbutton"
                           onclick="showUploadDialog('02', '', '采购凭证', 'imgPriviewOuter', 'imgPriviewInner');">
                ...
                <tr>
                    <td>
                        <table height="216px;" id="imgList" width="100%" class="easyui-datagrid" striped="true"
                               singleSelect="true">
                            <thead>
                            <tr>
                                <th field="originalName" width="50%" align="center">采购凭证
                                </td>
