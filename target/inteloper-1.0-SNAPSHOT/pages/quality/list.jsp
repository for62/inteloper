...
<div region="center" border="false" style="padding:5px;">
    <fieldset id="queryBlock" class="fieldset_common_style">
        <form id="qualityform" name="qualityform" method="post"
              action="${pageContext.request.contextPath}/quality/list?flag=2">
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_query_style editableFalse">
                        ...
                        <select id="year" name="year" class="easyui-combobox" style="width:120px;height:25px"
                    ...
                    <td class="table_common_td_txt_query_style">
                        ...
                        <select id="qualityStatus" name="qualityStatus" class="easyui-combobox"
                                style="width:120px;height:25px" data-options="editable:true">
                            <option value="" selected>-=请选择=-</option>
                ...
                <tr>
                    ...
                    <td colspan="4" class="table_common_td_txt_query_style editableFalse">
                        <input id="beginDate" comboname="beginDate" textboxname="beginDate"
                               class="easyui-datebox datebox-f combo-f textbox-f" value=""
                               data-options="required:false,showSeconds:false" style="width: 100px; display: none;"
                               editable="false">
                        ~
                        <input id="endDate" comboname="endDate" textboxname="endDate"
                               class="easyui-datebox datebox-f combo-f textbox-f" value=""
                               data-options="required:false,showSeconds:false" style="width: 100px; display: none;"
                               editable="false">
                    </td>
