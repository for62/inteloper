...
<script type="text/javascript">
    ...
    function edit(id) {
        ...
        var url = "${pageContext.request.contextPath}/graiReg/editInput?retFlag=1";
        url += "&id=" + id;
        url += "&page=" + page;
    ...
    function add(id) {
        ...
        var url = "graiRegEdit.jsp?retFlag=1";
        url += "&page=" + page;
        url += "&pageSize=" + pageSize;
        url += "&year=" + year;
        url += "&companyCode=" + companyCode;
    ...
    function view() {
        ...
        var url = "${pageContext.request.contextPath}/graiReg/view?id=" + id + "&retFlag=1";
        url += "&year=" + year;
        url += "&companyCode=" + companyCode;
        url += "&beginDate=" + beginDate;
        url += "&endDate=" + endDate;
