...
<div region="center" border="false" style="padding:5px;">
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_query_style">
                        <input name="roleCode" value="${data.roleCode }" class="easyui-textbox"
                    ...
                    <td class="table_common_td_txt_query_style">
                        <input name="roleName" value="${data.roleName }" class="easyui-textbox"
                               style="width:200px;height:25px">
                    </td>
    ...
    <table id="data" class="easyui-datagrid" striped="true" checkbox="true" singleSelect="false" singleSelect="true"
        ...
        <c:forEach items="${pageModel.list }" var="r">
            <tr>
...
<script type="text/javascript">
    ...
    function addRole() {
        $('#addDialog').dialog({
            ...
            closed: false,
            cache: false,
            href: '${pageContext.request.contextPath}/role/add.do',
            modal: true
        });
    }
    ...
    function detail() {
        ...
        $('#addDialog').dialog({
            ...
            closed: false,
            cache: false,
            href: '${pageContext.request.contextPath}/role/detail?id=' + id,
            modal: true
        });
    }
    ...
    function roleAuth() {
        ...
        $('#addDialog').dialog({
            ...
            closed: false,
            cache: false,
            href: '${pageContext.request.contextPath}/role/roleAuth.do?id=' + id,
            modal: true
        });
    }
