            ...
            <tr>
                    ...
                    <fieldset style="border: 1px solid #99BBE8; height:300px;">
                        ...
                        <table>
                            <tr height="50">
                                ...
                                <td width="30%">
                                    <select id="cityCode" name="cityCode" class="easyui-combobox" editable="false"
                                            style="width:180px;height:25px" data-options='required:true'>
                            ...
                            <tr height="50">
                                ...
                                <td width="200">
                                    <select id="townCode" name="townCode" class="easyui-combobox" editable="false"
                                            style="width:180px;height:25px" data-options='required:true'>
                            ...
                            <tr height="70">
                                <td colspan="2" align="center">
                                    ...
                                    <a href="javascript:void(0)" style="margin-left:30px;" class="easyui-linkbutton"
                                       style="margin-left:15px;" onclick="closeDialog()"
                ...
                <td width="50%">
                    <fieldset style="border: 1px solid #99BBE8;height:300px;">
                        <table border="0">
                            <tr>
                                <td><img src="${pageContext.request.contextPath}/images/nothing.png"
                                         style="width:360px;height:300px;" border="0"/></td>
                            </tr>
                        </table>
                    </fieldset>
                </td>
...
<script type="text/javascript">
    ...
    function checkUploaded() {
        ...
        showLoading();
        Public.ajaxGet('${pageContext.request.contextPath}/landPic/checkUploaded', {
