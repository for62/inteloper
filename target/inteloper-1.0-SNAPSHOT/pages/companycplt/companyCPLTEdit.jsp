            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style editableFalse" colspan="3">
                        <input class="easyui-datebox" id="complaintDate" name="complaintDate"
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" id="complainant" name="complainant" value=""
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        ...
                        <select id="complainantSex" name="complainantSex" class="easyui-combobox"
                                style="width:170px;height:25px" data-options="editable:false">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" id="complainantTel" name="complainantTel" value=""
                               style="width:170px;"></input>
                    </td>
                    <td class="table_common_td_label_style">联系邮箱：</td>
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" id='complainantMail' name="complainantMail" value=""
                               style="width:170px;"></input>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" class="table_common_td_txt_style">
                        <textarea class="easyui-textbox" rows="5" cols="64" id="complaintContent"
                                  name="complaintContent" style="font-size:12px;height:80px;width:560px;"
