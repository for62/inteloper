        ...
        <form>
            ...
            <table style="width:98%;">
                ...
                <tr>
                    ...
                    <td width="100">
                        <textarea class="easyui-textbox" rows="2" id="fileInfo" name="remark"
                                  style="width:300px;height:60px" data-options="multiline:true"></textarea>
                    </td>
                </tr>
                <tr height="50">
                    <td colspan="2" align="center">
                        <a href="javascript:void(0)" id="uploadDiv" class="easyui-linkbutton"
                           style="height:30px; width:80px;" onclick="upload()">上传</a>
                        <a href="javascript:void(0)" id="uploadDiv" class="easyui-linkbutton"
