            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-datebox" id="monitorDate" name="monitorDate"
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" id="tsp" name="tsp" value=""
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" id="so2" name="so2" value=""
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" type="text" id="no2" name="no2" value=""
                               data-options="min:0,max:999999999.99,precision:3,groupSeparator:','"
                               style="width:170px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
