...
<div region="center" border="false" style="padding: 5px;">
        ...
        <form id="inputForm" name="inputForm" method="get"
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_query_style"><input class="easyui-datebox" id="beginDate"
                                                                       name="beginDate"
                                                                       value=""
    ...
    <fieldset id="toolBlock" class="fieldset_common_style">
        <table>
            <tr>
                <td><a href="#" class="easyui-linkbutton" onclick="view();">
							<span class="l-btn-left"> <span
                                    class="l-btn-text icon-view l-btn-icon-left">查看</span>
						</span>
                </a> <a href="#" class="easyui-linkbutton" onclick="add();"> <span
                        class="l-btn-left"> <span
                        class="l-btn-text icon-add l-btn-icon-left">添加</span>
						</span>
                </a> <a href="#" class="easyui-linkbutton" onclick="edit();"> <span
                        class="l-btn-left"> <span
    ...
    <table id="data" class="easyui-datagrid" striped="true"
           singleSelect="false" pageSize="15"
           pageNumber="1">
        <thead>
        <tr>
            ...
            <th field="tsp" width="120" align="center">TSP(mg/m³)</th>
            <th field="so2" width="120" align="center">SO2(mg/m³)</th>
            <th field="no2" width="120" align="center">NO2(mg/m³)</th>
