            ...
            <table class="table_common_style">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        ...
                        <select id="monitorPointType" name="monitorPointType" class="easyui-combobox"
                                style="width:170px;px;height:25px" data-options="editable:true">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="monitorPointAddress" name="monitorPointAddress" value=""
                               style="width:170px;">
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="sectionDescription" value=""
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="longitude" value=""
                               style="width:170px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
