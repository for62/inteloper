...
<div region="center" border="false" style="padding:5px;">
    <fieldset id="queryBlock" class="fieldset_common_style">
        ...
        "" method="post" action="${pageContext.request.contextPath}/securityCode/applyList?flag=2">
        <table class="table_common_style">
            <tr>
                ...
                <td nowrap>
                    ...
                    <select id="companyCode" name="companyCode" class="easyui-combobox" style="width:200px;height:25px"
