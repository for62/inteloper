...
<div region="center" border="false" style="padding:5px;">
        ...
        <form id="userform" name="userform" method="post" action="${pageContext.request.contextPath}/user/list.do?flag=2">
            <table class="table_common_style">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_query_style">
                        <s:select name="userType" id="uType" entityName="CommonData" value="${data.userType }"
                                  codeKey="UserType" hasPleaseSelectOption="true"></s:select>
    ...
    <table id="data" class="easyui-datagrid" striped="true" checkbox="true" singleSelect="true"
           pageSize="${pageModel.pageSize }" pageNumber="${pageModel.pageNum }">
        <thead>
        <tr>
        ...
        <c:forEach items="${pageModel.list }" var="user">
            <tr>
                ...
                <td height="30" align="center" nowrap><s:showName entityName="CommonData" codeKey="UserType"
                                                                  value="${user.userType }"></s:showName></td>
                ...
                <td height="30" align="center" nowrap><s:showName entityName="CommonData" codeKey="LoginStatus"
                                                                  value="${user.loginStatus }"></s:showName></td>
...
<script type="text/javascript">
    ...
    function addUser() {
        $('#addDialog').dialog({
            ...
            closed: false,
            cache: false,
            href: '${pageContext.request.contextPath}/user/add.do',
            modal: true
        });
    }
    ...
    function editUser() {
        ...
        $('#addDialog').dialog({
            ...
            closed: false,
            cache: false,
            href: '${pageContext.request.contextPath}/user/edit.do?userID=' + rows[0].userId,
            modal: true
        });
    }
