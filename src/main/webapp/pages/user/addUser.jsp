        ...
        <form id="addUserFrom" class="easyui-form" method="post" data-options="novalidate:true">
            <table class="table_common_style">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <s:select name="userType" id="userType" entityName="CommonData" codeKey="UserType"
                                  hasPleaseSelectOption="true" cssClass="easyui-combobox" width="150"
                                  height="25px"></s:select>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <s:select name="companyCode" id="companyCode" entityName="Company" hasPleaseSelectOption="true"
                                  cssClass="easyui-combobox" width="150" height="25px"></s:select>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-combobox" id="role" name="role" style="width:150px"
                               data-options='valueField:"roleCode",textField:"roleName",data:${roleList },multiple:true,panelHeight:"auto"'
                               editable="false">
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" class="table_common_td_txt_style">
                        <textarea class="easyui-textbox" rows="2" id="remark" name="remark"
                                  style="width:420px;height:60px" data-options="multiline:true"></textarea>
                    </td>
                </tr>
                <tr height="30">
