            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td>
                        ...
                        <select id="companyCode" name="companyCode" class="easyui-combobox"
                                style="width:170px;height:25px" data-options="editable:true">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select id="bizType" name="bizType" class="easyui-combobox" style="width:170px;height:25px"
                                data-options="editable:true">
                            <option value="" selected>-=请选择=-</option>
                    ...
                    <td>
                        <a href="javascript:void(0)" class="easyui-linkbutton" onclick="javascript:procImgUpload();">
							<span class="l-btn-left"><span
                                    class="l-btn-text icon-docupload l-btn-icon-left">上传过程图片</span>
                        </a>
                    </td>
                ...
                <tr>
                    <td>
                        <table id="imgList" height="250" class="easyui-datagrid" striped="true" singleSelect="true">
                            <thead>
                            <tr>
                                <th field="originalName" width="50%" align="center">过程图片
                                </td>
                                <th field="fileInfo" width="30%" align="center">过程图片描述
                                </td>
                ...
                <tr>
                    <td colspan="2" valign="top">
                        <table height="200" id="videoList" class="easyui-datagrid" striped="true" singleSelect="true">
                            <thead>
                            <tr>
                                <th field="videoURL" width="50%" align="center">过程视频URL
                                </td>
                                <th field="urlDesc" width="30%" align="center">过程视频描述
                                </td>
                                <th field="op" width="20%" align="center">操作
                                </td>
                            </tr>
...
<script type="text/javascript">
    ...
    function add() {
        ...
        var bizType = $("#bizType").combobox('getValue');
        bizType = getImgBizType(bizType);
        Public.ajaxGet(root + '/file/addVideo?t=' + (new Date).getTime(), {
                bizType: bizType,
                bizCode: bizCode,
                filePath: vUrl,
                fileInfo: desc
