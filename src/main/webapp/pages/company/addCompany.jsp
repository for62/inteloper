    ...
    <form id="addCompanyform" class="easyui-form" method="post" data-options="novalidate:true">
        <table cellpadding="6" style="text-align:center;">
            <tr>
                ...
                <td><input class="easyui-textbox" type="text" id=companyCode name="companyCode"
                           style="width:200px;"></input></td>
            </tr>
            <tr>
                <td align="right">企业名称：</td>
                <td><input class="easyui-textbox" type="text" id="companyName" name="companyName"
                           style="width:200px;"></input></td>
            </tr>
            <tr>
                <td align="right">企业法人：</td>
                <td>
                    <input class="easyui-textbox" type="text" id="legalPerson" name="legalPerson"
                           style="width:200px;"></input></td>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" type="text" id="legalPersonID" name="legalPersonID"
                           style="width:200px;"></input></td>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" type="text" id="address" name="address" style="width:200px;"></input>
                </td>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" type="text" id="connectName" name="connectName"
                           style="width:200px;"></input></td>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input class="easyui-textbox" type="text" id="connectPhone" name="connectPhone"
                           style="width:200px;"></input></td>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <select id="companyType" name="companyType" class="easyui-combobox" style="width:200px;height:25px"
