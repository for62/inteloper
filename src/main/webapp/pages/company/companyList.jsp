...
<div region="center" border="false" style="padding:5px;">
    <fieldset id="queryBlock" class="fieldset_common_style">
        <form id="companylistform" name="companylistform" method="post"
              action="${pageContext.request.contextPath}/company/list?flag=2">
            <table class="table_common_style">
                <tr>
                    <td class="table_common_td_label_query_style">企业编码：</td>
                    <td class="table_common_td_txt_query_style">
                        <input class="easyui-textbox" type="text" name="companyCode" value=""
                               style="width:200px;height:25px;"></input>
                    ...
                    <td class="table_common_td_txt_query_style">
                        <input class="easyui-textbox" type="text" name="companyName" value=""
                               style="width:200px;height:25px;"></input>
                    </td>
                </tr>
                <tr>
