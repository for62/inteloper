            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        ...
                        <select id="year2" name="year" class="easyui-combobox" style="width:187px;height:25px"
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        ...
                        <select id="seedCode" name="seedCode" class="easyui-combobox" style="width:187px;height:25px"
                                data-options="editable:false">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" precision="1" type="text" name="minYield" value=""
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" precision="1" type="text" name="maxYield" value=""
                               data-options="min:0,max:999999999.99,precision:2,groupSeparator:','"
                               style="width:187px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
