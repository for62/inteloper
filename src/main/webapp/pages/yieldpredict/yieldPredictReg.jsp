...
<div region="center" border="false" style="padding:5px;">
    ...
    <form id="yieldRegform" name="yieldRegform" method="post"
          action="${pageContext.request.contextPath}/yieldPredict/reg?flag=2">
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_query_style editableFalse">
                        ...
                        <select id="year" name="year" class="easyui-combobox" style="width:170px;height:25px"
                    ...
                    <td class="table_common_td_txt_query_style">
                        ...
                        <select id="companyCode" name="companyCode" class="easyui-combobox"
                                style="width:200px;height:25px" data-options="editable:true">
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input id="evalYield" value="0.0" class="easyui-textbox" style="width:120px;height:25px"
                               readonly>
                    </td>
                    <td class="table_common_td_label_style">收粮量（斤）：</td>
                    <td class="table_common_td_txt_style">
                        <input id="buyValue" value="0.0" class="easyui-textbox" style="width:200px;height:25px"
                               readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3" class="table_common_td_txt_style">
                        <input id="maxPredictYield" value="0.0" class="easyui-textbox" style="width:120px;height:25px"
                               readonly>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input id="predictedYield" value="0.0" class="easyui-textbox" style="width:120px;height:25px"
                               readonly>
                    </td>
                    <td class="table_common_td_label_style">本次可预报产量（斤）：</td>
                    <td class="table_common_td_txt_style">
                        <input id="restPredictYield" value="0.0" class="easyui-textbox" style="width:200px;height:25px"
                               readonly>
                    </td>
                </tr>
            </table>
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        <input class="easyui-datebox" editable="false" name="predictDate" id="predictDate"
                               value="2017-05-21" data-options="required:false,showSeconds:false" style="width:120px"/>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                    <td class="table_common_td_label_style">本次预报产量（斤）：</td>
                    <td class="table_common_td_txt_style">
                        <input id="currentValue" class="easyui-textbox" style="width:120px;height:25px" value="0.00"
                               readonly>
                    </td>
                </tr>
            </table>
    ...
    <table id="data" class="easyui-datagrid" striped="true" checkbox="true" singleSelect="false" pageSize="15"
           pageNumber="1">
        <thead>
        <tr>
...
<script type="text/javascript">
    ...
    function savePredict() {
        ...
        showLoading();
        Public.ajaxGet('${pageContext.request.contextPath}/yieldPredict/save', {
            year: year,
