...
<head>
    ...
    <style type="text/css">
        * {
        ...
        body {
            background: url("${pageContext.request.contextPath}/images/loginbg.jpg") no-repeat top center;
            overflow: hidden;
        }
        ...
        .login {
            width: 256px;
            height: 276px;
            background: url("/images/loginInputBg.png") no-repeat center center;
            position: absolute;
            color: #6b6b6b;
            font-size: 14px;
            top: 186px;
...
<div class="loginC">
    <div class="login">
        <form id="login-form" method="post" action="${pageContext.request.contextPath}/user/login.do">
            <ul>
                <li>
