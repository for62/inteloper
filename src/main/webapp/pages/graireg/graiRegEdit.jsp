...
<head>
    ...
    <!-- 图片播放 -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/style/jquery.fancybox.css"
          media="screen"/>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        ...
                        <select id="companyCode" name="companyCode" class="easyui-combobox"
                                style="width:187px;height:20px" data-options="editable:true">
        ...
        <fieldset class="fieldset_common_style">
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="idNumber" id="idNumber" value=""
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style" colspan="5">
                        <input class="easyui-textbox" type="text" name="farmerName" readonly="readonly" id="farmerName"
                               value="" style="width:150px;"></input>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_common_td_txt_style" colspan="5">
                        ...
                        <select class="easyui-combobox" id="tmp_townCodeView" name="tmp_townCodeView"
                                data-options='editable:false' style="width:150px" disabled>
                            <option value="" selected></option>
                        </select>
                        <input type="hidden" id="townCode" name="townCode" value="">
                        <select class="easyui-combobox" id="tmp_countryCodeView" name="tmp_countryCodeView"
                                data-options='editable:false' style="width:150px" disabled>
                            <option value="" selected></option>
                        </select>
                        <input type="hidden" id="countryCode" name="countryCode" value="">
                        <input type="text" class="easyui-textbox" id="groupName" name="groupName" value=""
                               readonly="readonly">
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" readonly="readonly" precision="2" style="width:120px;"
                               min="0.00" max="9999999.99" type="text" name="dkzmj" value="" id="dkzmj"/>
                    </td>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" readonly="readonly" precision="2" style="width:120px;"
                               min="0.00" max="9999999.99" type="text" name="registeredTotalYield" value=""
                               id="registeredTotalYield"/>
                    </td>
                    <td class="table_common_td_label_style">收粮面积(亩)：</td>
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" readonly="readonly" precision="2" style="width:120px;"
                               min="0.00" max="9999999.99" type="text" name="grainTotalYield" value=""
                               id="grainTotalYield"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                        <table height="150px;" id="datas" width="100%" class="easyui-datagrid" striped="true"
                               singleSelect="true">
                            <thead>
                            <tr>
                                <th field="landType" width="20%" height="20" align="center" nowrap>土地类型
                                </td>
                                <th field="aMu" width="15%" height="20" align="center" nowrap>实（亩）
                                </td>
                                <th field="cMu" width="15%" height="20" align="center" nowrap>测量（亩）
                                </td>
                                <th field="landClass" width="20%" height="20" align="center" nowrap>土地类别
                                </td>
                                <th field="landName" width="30%" height="20" align="center" nowrap>地块名称
                                </td>
                            </tr>
                            </thead>
                            <tbody>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" precision="2" min="0.00" max="9999999.99" type="text"
                               name="seedPurchaseTotal" value="" id="seedPurchaseTotal"/>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
            </table>
            ...
            <table class="table_common_style">
                ...
                <tr>
                    ...
                    <td colspan="2" class="table_common_td_txt_style">
                        <input name="thisWeight" id="thisWeight" class="easyui-numberbox" precision="2" min="0.00"
                               max="9999999.99" value="" style="width:150px;">
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input name="operatorName" id="operatorName" value="" class="easyui-textbox"
                               style="width:150px;">
                        <span class="span_common_mustinput_style">*</span>
                    </td>
