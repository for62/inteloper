...
<div region="center" border="false" style="padding:5px;">
    <fieldset id="queryBlock" class="fieldset_common_style">
        <form id="inputForm" name="inputForm" method="get" action="../graiFore/list">
        ...
        <table>
            <tr>
                <td>
                    ...
                    <a href="#" class="easyui-linkbutton" onclick="return importData();">
							<span class="l-btn-left">
								<span class="l-btn-text icon-import l-btn-icon-left">导入</span>
							</span>
                    </a>
...
<script type="text/javascript">
    ...
    function importTempDown() {
        document.location.href = "${pageContext.request.contextPath}/temp/收粮预报模板.xlsx";
    }
</script>
</body>
</html>