            ...
            <table class="table_common_style">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        ...
                        <select id="companyCode1" name="companyCode" class="easyui-combobox"
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        ...
                        <select id="contractorType" name="contractorType" class="easyui-combobox"
                                style="width:187px;height:25px" data-options="editable:false">
                            <option value="" selected>-=请选择=-</option>
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        ...
                        <select id="idType" name="idType" class="easyui-combobox" style="width:187px;height:25px"
                                data-options="editable:false">
                            <option value="" selected>-=请选择=-</option>
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="contractorName" value="" style="width:188px;"
                               maxlength="10"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                    <td class="table_common_td_label_style">证件号码：</td>
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="contractorID" value=""
                               style="width:188px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
                <tr>
...
<select id='cityCode' name='cityCode' class='easyui-combobox' style='width:140px;height:25px'
        data-options='editable:false'>
		<option value='230184'>五常市</option>
</select> 
</span>
                        <span id='townSpan'><select id='townCode' name='townCode' class='easyui-combobox'
                                                    style='width:150px;height:25px'
                                                    data-options='editable:false,required:true'>	<option value=''
                                                                                                            selected>-=请选择=-</option>
		...
		<option value='109'>沙河子镇</option>
                        ...
                        <span id='countrySpan'><select id='countryCode' name='countryCode' class='easyui-combobox'
                                                       style='width:140px;height:25px'
                                                       data-options='editable:false'></select></span>
                        <span id='groupSpan'><input class='easyui-textbox' type='text' id='groupName' name='groupName'
                                                    value='' style='width:260px;height:25px'></select></span>
                        <script>
                            $(document).ready(function () {
                                $('#cityCode').combobox({
                                    valueField: 'id',
                                ...
                                $('#townCode').combobox({
                                    ...
                                    onChange: function () {
                                        ...
                                        Public.ajaxGet('${pageContext.request.contextPath}/areaDevision/getCountrysByCityAndTownCode', {
                                            cityCode: cityCode,
                                            townCode: townCode
                                        }, function (e) {
                                            if (200 == e.status) {
            ...
            <table class="table_common_style">
                <tr>
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        ...
                        <select id="landType" name="landType" class="easyui-combobox" style="width:100pxpx;height:25px"
                                data-options="editable:false">
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" precision="2" min="0.00" max="9999999.99" name="actualMu"
                               value="" style="width:120px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                    ...
                    <td class="table_common_td_txt_style editableFalse">
                        ...
                        <select id="landClass" name="landClass" class="easyui-combobox" style="width:110px;height:25px"
                                data-options="editable:false">
                            <option value="" selected>-=请选择=-</option>
...
<span style='display:none'>
<select id='cityCodeDetail' name='cityCodeDetail' class='easyui-combobox' style='width:146px;height:25px'
        data-options='editable:false'>
		<option value='230184'>五常市</option>
</select> 
</span>
                        <span id='townSpan'><select id='townCodeDetail' name='townCodeDetail' class='easyui-combobox'
                                                    style='width:150px;height:25px'
                                                    data-options='editable:false,required:true'>	<option value=''
                                                                                                            selected>-=请选择=-</option>
		<option value='100'>五常镇</option>
		...
		<option value='109'>沙河子镇</option>
                        ...
                        <span id='countrySpan'><select id='countryCodeDetail' name='countryCodeDetail'
                                                       class='easyui-combobox' style='width:146px;height:25px'
                                                       data-options='editable:false'></select></span>
                        <span id='groupSpan'><input class='easyui-textbox' type='text' id='groupNameDetail'
                                                    name='groupNameDetail' value=''
                                                    style='width:265px;height:25px'></select></span>
                        <script>
                            $(document).ready(function () {
        ...
        <fieldset class="fieldset_common_style">
            <table class="table_common_style">
                ...
                <tr>
                    ...
                    <td class="table_common_td_txt_style">
                        <input class="easyui-numberbox" precision="2" min="0.00" max="9999999.99" type="text"
                               name="archiveAcreage" value="" style="width:100px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                    <td class="table_common_td_label_style">经办人：</td>
                    <td class="table_common_td_txt_style">
                        <input class="easyui-textbox" type="text" name="operatorName" value=""
                               style="width:100px;"></input>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                    <td class="table_common_td_label_style">经办日期：</td>
                    <td class="table_common_td_txt_style editableFalse">
                        <input class="easyui-datebox" name="operatorDate" id="operatorDate"
                               value="Sun May 21 00:00:00 CST 2017"
                ...
                <tr>
                    ...
                    <td colspan="5" class="table_common_td_txt_style">
                        <textarea class="easyui-textbox" rows="3" id="description" name="description" cols="60"
                                  style="width:500px;height:100px" data-options="multiline:true"></textarea>
                        <span class="span_common_mustinput_style">*</span>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        <a href="#" class="easyui-linkbutton"
                           onclick="javascript:showUploadDialog('04', '', '举证资料', 'imgPriviewOuter', 'imgPriviewInner');">
                            <span class="l-btn-left"><span
                                    class="l-btn-text icon-docupload l-btn-icon-left">上传举证凭证</span></span>
                        </a>
                    </td>
                </tr>
                <tr>
                    <td>
                        <table id="imgList" height="152px" class="easyui-datagrid" striped="true" singleSelect="true">
                            <thead>
                            <tr>
                                <th field="originalName" width="50%" align="center">举证凭证
                                </td>
                                <th field="fileInfo" width="30%" align="center">说明
                                </td>
                                <th field="op" width="20%" align="center">操作
                                </td>
                            </tr>
                            </thead>
                        </table>
                ...
                <tr>
                    <td>
                        ...
                        <link rel="stylesheet" type="text/css"
                              href="${pageContext.request.contextPath}/style/jquery.scrollpic.css">

                        <link rel="stylesheet" type="text/css"
                              href="${pageContext.request.contextPath}/style/jquery.fancybox.css" media="screen"/>

                        <link rel="stylesheet" type="text/css"
                              href="${pageContext.request.contextPath}/style/jquery.fancybox-buttons.css"/>

                        <script type="text/javascript"
                                src="${pageContext.request.contextPath}/js/jquery.ScrollPic.js"></script>
                        ...
                        <div id='imgPriviewOuter'>
                            <div class="yiz-slider-3 yiz-slider" id="imgPriviewInner" data-yiz-slider="3"
                                 style="width:420px;height:500px">

                                <ul>

                                    <li><img src="${pageContext.request.contextPath}/images/nothing.png"
                                             alt="There is nothing to View."/></li>
